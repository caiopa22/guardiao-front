...
export function DialogDemo({ children }: { children: React.ReactNode }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[600px] dark">
        <DialogHeader>
        ...
        <DialogFooter>
            ...
            <Button className="w-full h-12 text-white">Tirar foto</Button>
...
export default function VaultPage() {
    return (
        <div className="flex flex-col min-h-screen items-start  bg-secondary dark">
            <Header />
